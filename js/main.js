  ...
  "pt": {
    ...
    "project10Desc": "Uma recriação digital de Catan desenvolvida em Unity, com suporte a partidas multiplayer online por meio do Unity Relay. No jogo, os jogadores expandem seus assentamentos por um mapa formado por diferentes tipos de terreno, coletando recursos, construindo estradas, vilas e cidades e realizando trocas para acumular pontos e alcançar a vitória. O projeto também conta com sistema de localização, permitindo exibir legendas e textos da interface em diferentes idiomas e tornando a experiência mais acessível para jogadores de diferentes regiões.",
  ...
  "en": {
    ...
    "project10Desc": "A digital recreation of Catan developed in Unity, with support for online multiplayer matches through Unity Relay. Players expand their settlements across a map made up of different terrain types, gathering resources, building roads, settlements and cities, and trading to earn points and achieve victory. The project also includes a localization system that displays subtitles and interface text in different languages, making the experience more accessible to players from different regions.",
